...
export class StandardTimingWindow extends TimingWindow {
  ...
  constructor(id: string, name: string, color: number, timingWindowMS: number, dancePoints: number, lifeChange: number, judgmentTexture: JudgmentTexture) {
...
export const TIMING_WINDOW_AUTOPLAY = new StandardTimingWindow("w0", "Fantastic", 0x2cce8, 0, 0, 0, JudgmentTexture.ITG)
