export const TIMING_EVENT_NAMES = ["BPMS", "STOPS", "WARPS", "DELAYS", "LABELS",
"SPEEDS", "SCROLLS", "TICKCOUNTS", "TIMESIGNATURES", "COMBOS", "FAKES",
"ATTACKS", "BGCHANGES", "FGCHANGES"] as const

export type TimingEventProperty = typeof TIMING_EVENT_NAMES[number]
export type TimingProperty = "OFFSET" | TimingEventProperty

export const BEAT_TIMING_EVENT_NAMES = ["BPMS", "STOPS", "WARPS", "DELAYS", "WARP_DEST"] as const
...
export interface BPMTimingEvent extends TimingEventBase, BeatCacheTimingEventBase {
  type: "BPMS",
  beat: number,
  value: number
}
export interface StopTimingEvent extends TimingEventBase, BeatCacheTimingEventBase {
  type: "STOPS",
  beat: number,
  value: number
}
export interface WarpTimingEvent extends TimingEventBase, BeatCacheTimingEventBase {
  type: "WARPS",
  beat: number,
  value: number
}
...
export interface DelayTimingEvent extends TimingEventBase, BeatCacheTimingEventBase {
  type: "DELAYS",
  beat: number,
  value: number
}
...
export type TimingEvent = BPMTimingEvent | StopTimingEvent | WarpTimingEvent 
| DelayTimingEvent | ScrollTimingEvent | TickCountTimingEvent | FakeTimingEvent | LabelTimingEvent | SpeedTimingEvent
| TimeSignatureTimingEvent | ComboTimingEvent | AttackTimingEvent | BGChangeTimingEvent | FGChangeTimingEvent

export type BeatCacheTimingEvent = BPMTimingEvent | StopTimingEvent | WarpTimingEvent 
| DelayTimingEvent | WarpDestTimingEvent