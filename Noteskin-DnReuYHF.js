...
31 43 42
31 20 43
20 32 43`,l0=a.from(i0);class g{static arrowPartsTex=f.from(C0,{mipmap:E.OFF});static minePartsTex=f.from(s0,{mipmap:E.OFF});static liftPartsTex=f.from(r0,{mipmap:E.OFF});static liftQuantsTex=f.from(e0,{mipmap:E.OFF});static arrowBodyGeom;static arrowFrameGeom;static liftBodyGeom;static liftFrameGeom;static mineBodyGeom;static arrowFrameTex;static arrowFrame;static arrowTex;static arrowContainer=new v;static liftTex;static liftContainer=new v;static mineTex;static mineContainer=new v;static loaded=!1;static async initArrowTex(){if(!this.loaded){g.arrowFrameTex=D.create({width:64,height:64,resolution:P.performance.resolution}),g.arrowTex=D.create({width:256,height:320,resolution:P.performance.resolution}),g.liftTex=D.create({width:256,height:320,resolution:P.performance.resolution}),g.mineTex=D.create({width:64,height:64,resolution:P.performance.resolution}),this.arrowBodyGeom=await Q(I0),this.arrowFrameGeom=await Q(f0),this.mineBodyGeom=await Q(P0),this.liftBodyGeom=await Q(E0),this.liftFrameGeom=await Q(D0);{const A=w.from(I,Q0,{sampler0:this.arrowPartsTex}),n=new c(g.arrowFrameGeom,A);n.x=32,n.y=32,n.rotation=Math.PI,this.arrowFrame=n}for(let A=0;A<10;A++){const n=w.from(I,u,{sampler0:this.arrowPartsTex,time:0,quant:Math.min(A,8)}),t=new r(g.arrowFrameTex);t.x=A%3*64,t.y=Math.floor(A/3)*64;const B=new c(g.arrowBodyGeom,n);B.x=A%3*64+32,B.y=Math.floor(A/3)*64+32,B.rotation=Math.PI,B.name="body"+A,g.arrowContainer.addChild(t),g.arrowContainer.addChild(B)}for(let A=0;A<10;A++){const n=w.from(I,u,{sampler0:this.liftQuantsTex,time:0,quant:Math.min(A,8)}),t=w.from(I,w0,{sampler0:this.liftPartsTex}),B=new c(g.liftBodyGeom,n);B.x=A%3*64+32,B.y=Math.floor(A/3)*64+32,B.rotation=Math.PI,B.name="body"+A,g.liftContainer.addChild(B);const e=new c(g.liftFrameGeom,t);e.x=A%3*64+32,e.y=Math.floor(A/3)*64+32,e.rotation=Math.PI,e.name="frame"+A,g.liftContainer.addChild(e)}{const A=w.from(I,c0,{sampler0:this.minePartsTex,time:0}),n=new c(g.mineBodyGeom,A),t=new r(l0);t.width=64,t.height=64,t.anchor.set(.5),t.pivot.y=3,g.mineContainer.position.set(32),g.mineContainer.addChild(n),g.mineContainer.addChild(t)}this.loaded=!0}}static setArrowTexTime(A){if(!this.loaded)return;const n=A.chartManager.chartView.getVisualBeat(),t=A.chartManager.chartView.getVisualTime();for(let B=0;B<10;B++){const e=g.arrowContainer.getChildByName("body"+B);e.shader.uniforms.time=n/8;const L=g.liftContainer.getChildByName("body"+B);L.shader.uniforms.time=n/8;const H=g.liftContainer.getChildByName("frame"+B);H.shader.uniforms.time=n/8}g.mineContainer.children[0].shader.uniforms.time=t,g.mineContainer.rotation=t%1*Math.PI*2,A.renderer.render(g.arrowFrame,{renderTexture:g.arrowFrameTex}),A.renderer.render(g.arrowContainer,{renderTexture:g.arrowTex}),A.renderer.render(g.mineContainer,{renderTexture:g.mineTex}),A.renderer.render(g.liftContainer,{renderTexture:g.liftTex})}static setNoteTex(A,n){if(n!==void 0&&n.type=="Mine")A.texture=g.mineTex;else if(n!==void 0&&n.type=="Lift"){const t=[4,8,12,16,24,32,48,64,96,192].indexOf(n?.quant??4);A.texture=new a(g.liftTex.baseTexture,new p(t%3*64,Math.floor(t/3)*64,64,64))}else{const t=[4,8,12,16,24,32,48,64,96,192].indexOf(n?.quant??4);A.texture=new a(g.arrowTex.baseTexture,new p(t%3*64,Math.floor(t/3)*64,64,64))}}}const m0="/smeditor/assets/flashBright-WBniwOZj.png",v0="data:image/png;base64,",h0="/smeditor/assets/hold-BtPJfgG_.png",d0="/smeditor/assets/mine-CPFI4p0C.png",p0=a.from(m0),u0=a.from(v0),T0=a.from(h0),F0=a.from(d0),h={0:{tint:16777215,alpha:1,"scale.x":.8,"scale.y":.8},"0.5":{tint:16777215,alpha:1,"scale.x":1,"scale.y":1},1:{tint:16777215,alpha:0,"scale.x":1,"scale.y":1}},T=o=>({0:{tint:o,alpha:1,"scale.x":.4,"scale.y":.4},"0.5":{tint:o,alpha:1,"scale.x":.5,"scale.y":.5},1:{tint:o,alpha:0,"scale.x":.5,"scale.y":.5}}),d={w0:h,w1:h,w2:T(16777036),w3:T(65382),held:h};class x0 extends v{holdExplosion=new F(x(T0,4,1,160,160)[0]);bright=new r(p0);dim=new r(u0);anims=new Set;constructor(A,n){super(),A.on(this,"hit",t=>{if(n==t.columnNumber){let B=this.dim;if(t.judgement.id=="w0"&&(B=this.bright),d[t.judgement.id]===void 0)return;this.anims.forEach(e=>s.finish(e)),this.anims.clear(),this.anims.add(s.animate(B,d[t.judgement.id],.12))}}),A.on(this,"held",t=>{n==t.columnNumber&&(this.anims.forEach(B=>s.finish(B)),this.anims.clear(),this.anims.add(s.animate(this.bright,d.held,.12)))}),A.on(this,"holdon",t=>{n==t.columnNumber&&(this.holdExplosion.visible=!0)}),A.on(this,"holdoff",t=>{n==t.columnNumber&&(this.holdExplosion.visible=!1)}),A.on(this,"rollon",t=>{n==t.columnNumber&&(this.holdExplosion.visible=!0)}),A.on(this,"rolloff",t=>{n==t.columnNumber&&(this.holdExplosion.visible=!1)}),A.on(this,"hitmine",t=>{if(n==t.columnNumber){const B=new r(F0);B.alpha=0,B.anchor.set(.5),B.blendMode=y.ADD,this.addChild(B),s.animate(B,{0:{alpha:1,rotation:0},"0.5":{alpha:1,rotation:90*Math.PI/180},1:{alpha:0,rotation:180*Math.PI/180}},.4,void 0,()=>B.destroy())}}),this.holdExplosion.visible=!1,this.holdExplosion.anchor.set(.5),this.holdExplosion.scale.set(.5),this.holdExplosion.play(),this.addChild(this.holdExplosion),this.dim.scale.set(.5),this.dim.anchor.set(.5),this.dim.alpha=0,this.addChild(this.dim),this.bright.scale.set(.5),this.bright.anchor.set(.5),this.bright.alpha=0,this.addChild(this.bright)}}const L0="/smeditor/assets/receptor-SrJwFcbg.png",H0=a.from(L0),i={},C={};for(const o of["Left","Down","Up","Right","UpLeft","UpRight"])for(const A of["Body","BottomCap"])for(const n of["Active","Inactive"])i[o]===void 0&&(i[o]={}),i[o][n]===void 0&&(i[o][n]={}),i[o][n][A]=a.from(new URL(Object.assign({"./hold/downBodyActive.png":U,"./hold/downBodyInactive.png":b,"./hold/downBottomCapActive.png":N,"./hold/downBottomCapInactive.png":X,"./hold/leftBodyActive.png":G,"./hold/leftBodyInactive.png":J,"./hold/leftBottomCapActive.png":S,"./hold/leftBottomCapInactive.png":R,"./hold/rightBodyActive.png":Y,"./hold/rightBodyInactive.png":Z,"./hold/rightBottomCapActive.png":K,"./hold/rightBottomCapInactive.png":O,"./hold/upBodyActive.png":k,"./hold/upBodyInactive.png":V,"./hold/upBottomCapActive.png":z,"./hold/upBottomCapInactive.png":M,"./hold/upleftBodyActive.png":j,"./hold/upleftBodyInactive.png":q,"./hold/upleftBottomCapActive.png":W,"./hold/upleftBottomCapInactive.png":_,"./hold/uprightBodyActive.png":$,"./hold/uprightBodyInactive.png":A0,"./hold/uprightBottomCapActive.png":n0,"./hold/uprightBottomCapInactive.png":t0})[`./hold/${o.toLowerCase()}${A}${n}.png`],import.meta.url).href);for(const o of["body","bottomCap"])for(const A of["Active","Inactive"])C[A]===void 0&&(C[A]={}),C[A][o]=a.from(new URL(Object.assign({"./roll/bodyActive.png":o0,"./roll/bodyInactive.png":g0,"./roll/bottomCapActive.png":B0,"./roll/bottomCapInactive.png":a0})[`./roll/${o}${A}.png`],import.meta.url).href);const y0={Left:90,Down:0,Up:180,Right:-90,UpLeft:135,UpRight:-135,DownRight:-45,DownLeft:45},U0=["Receptor","Tap","Lift","Fake","Hold Inactive Head","Hold Active Head","Roll Inactive Head","Roll Active Head","NoteFlash"],J0={elements:{Left:{Receptor:o=>{let A;const n=new F(x(H0,2,1,256,256)[0]);return n.width=64,n.height=64,n.anchor.set(.5),o.noteskin.on(n,"ghosttap",t=>{t.columnNumber==o.columnNumber&&(s.finish(A),A=s.animate(n,{0:{alpha:1.2,width:48,height:48},1:{alpha:1,width:64,height:64}},.06))}),o.noteskin.onUpdate(n,t=>{const B=(t.getVisualBeat()%1+1)%1;n.currentFrame=B<.2?0:1}),n},Tap:o=>{const A=new r(a.WHITE);return g.setNoteTex(A,o.note),A.anchor.set(.5),A},NoteFlash:o=>new x0(o.noteskin,o.columnNumber),Fake:{element:"Tap"},Lift:{element:"Tap"},Mine:{element:"Tap"},"Hold Active Head":{element:"Tap"},"Hold Inactive Head":{element:"Tap"},"Hold Active Body":o=>new m(i[o.columnName].Active.Body),"Hold Inactive Body":o=>new m(i[o.columnName].Inactive.Body),"Hold Active TopCap":()=>new r(a.EMPTY),"Hold Inactive TopCap":()=>new r(a.EMPTY),"Hold Active BottomCap":o=>new l(i[o.columnName].Active.BottomCap),"Hold Inactive BottomCap":o=>new l(i[o.columnName].Inactive.BottomCap),"Roll Active Head":{element:"Tap"},"Roll Inactive Head":{element:"Tap"},"Roll Active Body":()=>new m(C.Active.body),"Roll Inactive Body":()=>new m(C.Inactive.body),"Roll Active TopCap":()=>new r(a.EMPTY),"Roll Inactive TopCap":()=>new r(a.EMPTY),"Roll Active BottomCap":()=>new l(C.Active.bottomCap),"Roll Inactive BottomCap":()=>new l(C.Inactive.bottomCap)}},load:function(o,A){const n=o.columnName;o.columnName="Left";const t=this.loadElement(o,A);return U0.includes(o.element)&&(t.rotation=y0[n]*Math.PI/180),t},init(){g.initArrowTex()},update(o){g.setArrowTexTime(o.chartManager.app)},hideIcons:["Lift"],metrics:{HoldBodyBottomOffset:-32,RollBodyBottomOffset:-32}};export{J0 as default};
