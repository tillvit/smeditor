...
31 43 42
31 20 43
20 32 43`,q=a.from(P);class e{static arrowBodyTex=h.from(k,{mipmap:d.OFF});static arrowFrameChromeTex=h.from(Y,{mipmap:d.OFF});static arrowFrameBlackTex=h.from(O,{mipmap:d.OFF});static minePartsTex=h.from(H,{mipmap:d.OFF});static liftFrameChromeTex=h.from(V,{mipmap:d.OFF});static liftFrameBlackTex=h.from(L,{mipmap:d.OFF});static arrowBodyGeom;static arrowFrameBlackGeom;static arrowFrameChromeGeom;static liftFrameBlackGeom;static liftFrameChromeGeom;static mineBodyGeom;static arrowFrameTex;static arrowChrome;static arrowBlack;static arrowFrameContainer=new u;static arrowTex;static arrowContainer=new u;static liftTex;static liftChrome;static liftBlack;static liftContainer=new u;static mineTex;static mineContainer=new u;static loaded=!1;static async initArrowTex(){if(!this.loaded){e.arrowFrameTex=x.create({width:64,height:64,resolution:g.performance.resolution}),e.arrowTex=x.create({width:256,height:320,resolution:g.performance.resolution}),e.liftTex=x.create({width:64,height:64,resolution:g.performance.resolution}),e.mineTex=x.create({width:64,height:64,resolution:g.performance.resolution}),this.arrowBodyGeom=await w(K),this.arrowFrameChromeGeom=await w(Q),this.arrowFrameBlackGeom=await w(J),this.mineBodyGeom=await w(z),this.liftFrameChromeGeom=await w(j),this.liftFrameBlackGeom=await w(W);{const t=p.from(C,b,{sampler0:this.arrowFrameChromeTex,time:0,quant:0}),r=new f(e.arrowFrameChromeGeom,t);r.x=32,r.y=32,r.rotation=-Math.PI/2,this.arrowChrome=r;const n=p.from(C,y,{sampler0:this.arrowFrameBlackTex}),o=new f(e.arrowFrameBlackGeom,n);o.x=32,o.y=32,o.rotation=-Math.PI/2,this.arrowBlack=o,this.arrowFrameContainer.addChild(r,o)}for(let t=0;t<10;t++){const r=p.from(C,b,{sampler0:this.arrowBodyTex,time:0,quant:t}),n=new s(e.arrowFrameTex);n.x=t%3*64,n.y=Math.floor(t/3)*64;const o=new f(e.arrowBodyGeom,r);o.x=t%3*64+32,o.y=Math.floor(t/3)*64+32,o.rotation=-Math.PI/2,o.name="body"+t,e.arrowContainer.addChild(n),e.arrowContainer.addChild(o)}{const t=p.from(C,b,{sampler0:this.liftFrameChromeTex,time:0,quant:0}),r=new f(e.liftFrameChromeGeom,t);r.x=32,r.y=32,r.rotation=-Math.PI/2,this.liftChrome=r;const n=p.from(C,y,{sampler0:this.liftFrameBlackTex}),o=new f(e.liftFrameBlackGeom,n);o.x=32,o.y=32,o.rotation=-Math.PI/2,this.liftBlack=o,this.liftContainer.addChild(r,o)}{const t=p.from(C,S,{sampler0:this.minePartsTex,time:0}),r=new f(e.mineBodyGeom,t),n=new s(q);n.width=64,n.height=64,n.anchor.set(.5),n.pivot.y=3,e.mineContainer.position.set(32),e.mineContainer.addChild(r),e.mineContainer.addChild(n)}this.loaded=!0}}static setArrowTexTime(t){if(!this.loaded)return;const r=t.chartManager.chartView.getVisualBeat(),n=t.chartManager.chartView.getVisualTime();for(let o=0;o<10;o++){const m=e.arrowContainer.getChildByName("body"+o);m.shader.uniforms.time=r}this.arrowChrome.shader.uniforms.time=r,this.liftChrome.shader.uniforms.time=r,e.mineContainer.children[0].shader.uniforms.time=n,e.mineContainer.rotation=n%1*Math.PI*2,t.renderer.render(e.arrowFrameContainer,{renderTexture:e.arrowFrameTex}),t.renderer.render(e.arrowContainer,{renderTexture:e.arrowTex}),t.renderer.render(e.mineContainer,{renderTexture:e.mineTex}),t.renderer.render(e.liftContainer,{renderTexture:e.liftTex})}static setNoteTex(t,r){if(r!==void 0&&r.type=="Mine")t.texture=e.mineTex;else if(r!==void 0&&r.type=="Lift")t.texture=e.liftTex;else{const n=[4,8,12,16,24,32,48,64,96,192].indexOf(r?.quant??4);t.texture=new a((r?.type??"Tap")=="Lift"?e.liftTex.baseTexture:e.arrowTex.baseTexture,new E(n%3*64,Math.floor(n/3)*64,64,64))}}}const X="/smeditor/assets/decent-B0IoKk3C.png",Z="/smeditor/assets/excellent-BNUXtplz.png",M="/smeditor/assets/fantastic-Bt6Wkd6m.png",R="/smeditor/assets/great-DNjRjjui.png",$="/smeditor/assets/hold-DAMy-lAi.png",_="/smeditor/assets/mine-CPFI4p0C.png",n0="/smeditor/assets/way_off-ds-qvjlG.png",r0="/smeditor/assets/white_fantastic-DJziOzv3.png",l={hold:a.from($),w0:a.from(M),w1:a.from(r0),w2:a.from(Z),w3:a.from(R),w4:a.from(X),w5:a.from(n0),mine:a.from(_)};class t0 extends u{holdExplosion=new s(l.hold);standard={w0:new s(l.w0),w1:new s(l.w1),w2:new s(l.w2),w3:new s(l.w3),w4:new s(l.w4),w5:new s(l.w5)};anims=new Set;constructor(t,r){super(),this.scale.set(.5),t.on(this,"hit",n=>{if(r==n.columnNumber&&this.standard[n.judgement.id]){this.anims.forEach(m=>A.finish(m)),this.anims.clear();const o=this.standard[n.judgement.id];this.anims.add(A.animate(o,{0:{alpha:1.2,"scale.x":1.1,"scale.y":1.1},1:{alpha:0,"scale.x":1,"scale.y":1}},.15,F(.11,0,.5,0)))}}),t.on(this,"held",n=>{if(r==n.columnNumber){this.anims.forEach(m=>A.finish(m)),this.anims.clear();const o=this.standard.w2;A.animate(o,{0:{alpha:1.2,"scale.x":1.1,"scale.y":1.1},1:{alpha:0,"scale.x":1,"scale.y":1}},.09,F(.11,0,.5,0))}}),t.on(this,"holdon",n=>{r==n.columnNumber&&(this.holdExplosion.visible=!0)}),t.on(this,"holdoff",n=>{r==n.columnNumber&&(this.holdExplosion.visible=!1)}),t.on(this,"rollon",n=>{r==n.columnNumber&&(this.holdExplosion.visible=!0)}),t.on(this,"rolloff",n=>{r==n.columnNumber&&(this.holdExplosion.visible=!1)}),t.on(this,"hitmine",n=>{if(r==n.columnNumber){const o=new s(l.mine);o.alpha=0,o.anchor.set(.5),o.blendMode=I.ADD,this.addChild(o),A.animate(o,{0:{alpha:1,rotation:0},"0.5":{alpha:1,rotation:90*Math.PI/180},1:{alpha:0,rotation:180*Math.PI/180}},.4,void 0,()=>o.destroy())}}),t.onUpdate(this,()=>{this.holdExplosion.alpha=Math.sin(Date.now()/1e3*Math.PI*2*20)*.1+1}),this.holdExplosion.visible=!1,this.holdExplosion.anchor.set(.5),this.addChild(this.holdExplosion);for(const n of Object.values(this.standard))n.alpha=0,n.anchor.set(.5),this.addChild(n)}}const o0="/smeditor/assets/receptor-w323eEs7.png",e0="/smeditor/assets/bodyActive-QV3GJ3TI.png",a0="/smeditor/assets/bodyInactive-0SQFeYsL.png",i0="/smeditor/assets/bottomCapActive-Cq37sDYX.png",s0="/smeditor/assets/bottomCapInactive-CuGjY0g4.png",m0="/smeditor/assets/bodyActive-BCL8hk_C.png",l0="/smeditor/assets/bodyInactive-CoEthcLO.png",c0="/smeditor/assets/bottomCapActive-DTa56uPb.png",A0="/smeditor/assets/bottomCapInactive-D4GNgKc3.png",U=a.from(o0),c={hold:{active:{body:a.from(e0),bottomCap:a.from(i0)},inactive:{body:a.from(a0),bottomCap:a.from(s0)}},roll:{active:{body:a.from(m0),bottomCap:a.from(c0)},inactive:{body:a.from(l0),bottomCap:a.from(A0)}}},h0={Left:0,Down:-90,Up:90,Right:180,UpLeft:45,UpRight:135,DownRight:-135,DownLeft:-45},d0=["Receptor","Tap","Lift","Fake","Hold Inactive Head","Hold Active Head","Roll Inactive Head","Roll Active Head","NoteFlash"],C0={elements:{Left:{Receptor:i=>{let t;const r=new u,n=new s(U);n.width=64,n.height=64,n.anchor.set(.5);const o=new s(U);return o.width=64,o.height=64,o.alpha=0,o.blendMode=I.ADD,o.anchor.set(.5),r.addChild(n,o),i.noteskin.on(r,"press",m=>m.columnNumber==i.columnNumber&&(o.alpha=.2)),i.noteskin.on(r,"lift",m=>m.columnNumber==i.columnNumber&&(o.alpha=0)),i.noteskin.on(r,"ghosttap",m=>{m.columnNumber==i.columnNumber&&(A.finish(t),t=A.animate(r,{0:{"scale.x":.75,"scale.y":.75},1:{"scale.x":1,"scale.y":1}},.11))}),i.noteskin.onUpdate(r,m=>{const D=(m.getVisualBeat()%1+1)%1,T=G(1-D,.5,1)*255;n.tint=N(T,T,T)}),r},Tap:i=>{const t=new s(a.WHITE);return e.setNoteTex(t,i.note),t.anchor.set(.5),t},NoteFlash:i=>new t0(i.noteskin,i.columnNumber),Fake:{element:"Tap"},Lift:{element:"Tap"},Mine:{element:"Tap"},"Hold Active Head":{element:"Tap"},"Hold Inactive Head":{element:"Tap"},"Hold Active Body":()=>new B(c.hold.active.body),"Hold Inactive Body":()=>new B(c.hold.inactive.body),"Hold Active TopCap":()=>new s(a.EMPTY),"Hold Inactive TopCap":()=>new s(a.EMPTY),"Hold Active BottomCap":()=>new v(c.hold.active.bottomCap),"Hold Inactive BottomCap":()=>new v(c.hold.inactive.bottomCap),"Roll Active Head":{element:"Tap"},"Roll Inactive Head":{element:"Tap"},"Roll Active Body":()=>new B(c.roll.active.body),"Roll Inactive Body":()=>new B(c.roll.inactive.body),"Roll Active TopCap":()=>new s(a.EMPTY),"Roll Inactive TopCap":()=>new s(a.EMPTY),"Roll Active BottomCap":()=>new v(c.roll.active.bottomCap),"Roll Inactive BottomCap":()=>new v(c.roll.inactive.bottomCap)}},load:function(i,t){const r=i.columnName;i.columnName="Left";const n=this.loadElement(i,t);return d0.includes(i.element)&&(n.rotation=h0[r]*Math.PI/180),n},init(){e.initArrowTex()},update(i){e.setArrowTexTime(i.chartManager.app)},hideIcons:["Lift"]};export{C0 as default};
