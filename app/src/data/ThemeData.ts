...
export const DEFAULT_THEMES: Record<string, Theme> = {
  ...
  pink: {
    "accent-color": new Color("#1783d0ff"),
    "text-color": new Color("#000000ff"),
    "text-color-secondary": new Color("#00000077"),
    "text-color-detail": new Color("#00000044"),
    "text-color-disabled": new Color("#00000088"),
    "primary-bg": new Color("#ff66c7ff"),
    "primary-border": new Color("#ff70dbff"),
    "primary-bg-active": new Color("#ff70dbff"),
    "primary-bg-hover": new Color("#ff85ffff"),
    "navbar-bg": new Color("#e65cb3ff"),
    "navbar-bg-inactive": new Color("#9a3e78ff"),
    "window-bg": new Color("#e65cb3ff"),
    "window-border": new Color("#00000000"),
    "secondary-bg": new Color("#cc529fff"),
    "secondary-border": new Color("#e05aafff"),
    "secondary-bg-active": new Color("#ff7befff"),
    "secondary-bg-hover": new Color("#ff6bcfff"),
    "editable-overlay-hover": new Color("#ffffff1a"),
    "editable-overlay-active": new Color("#ffffff33"),
    "input-bg": new Color("#ffffffff"),
    "input-bg-active": new Color("#ffffffff"),
    "input-bg-hover": new Color("#ffffffff"),
    "input-border": new Color("#e148a9ff"),
    "widget-bg": new Color("#cd3495ff"),
    "tooltip-bg": new Color("#e65cb3ff"),
    "editor-bg": new Color("#662950ff"),
  },
}
