...
declare module "app/src/util/Keybinds" {
  ...
  export class Keybinds {
    ...
    static createKeybindTooltip(
      element: Element
    ): (strings: TemplateStringsArray, ...ids: string[]) => void
...
declare module "app/src/chart/sm/SongTimingData" {
  ...
  export class SongTimingData extends TimingData {
    ...
    getColumn<Type extends TimingEventType>(
      ...
      {
        BPMS?:
          | import("app/src/chart/sm/TimingTypes").TimingColumn<
...
declare module "app/src/util/PixiUtil" {
  ...
  export function splitTex(
    ...
    xWidth: number,
    yWidth: number
  ): Texture<import("pixi.js").Resource>[][]
...
declare module "app/src/chart/component/notefield/NoteContainer" {
  ...
  import {
    Notefield,
    NoteWrapper,
  } from "app/src/chart/component/notefield/Notefield"
...
declare module "app/src/chart/component/notefield/Notefield" {
  ...
  import {
    ...
    NoteskinOptions,
    NoteskinSprite,
  } from "app/src/chart/gameTypes/noteskin/Noteskin"
  import { TimingWindow } from "app/src/chart/play/TimingWindow"
  import {
    HoldNotedataEntry,
    NotedataEntry,
...
declare module "app/src/chart/gameTypes/noteskin/Noteskin" {
  ...
  export class Noteskin {
    ...
    followRedirs(
      element: NoteskinElementOptions
    ): Generator<NoteskinSprite> | undefined
...
declare module "app/src/chart/gameTypes/noteskin/dance/default/ModelRenderer" {
  ...
  export class ModelRenderer {
    static arrowPartsTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static minePartsTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static liftPartsTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
...
declare module "app/src/chart/gameTypes/noteskin/dance/default/Noteskin" {
  ...
  const _default: {
    elements: {
      Left: {
        Receptor: (
          options: import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinElementCreationData
        ) => Container<import("pixi.js").DisplayObject>
        Tap: (
          options: import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinElementCreationData
        ) => Sprite
        NoteFlash: (
    ...
    load: (
      this: import("app/src/chart/gameTypes/noteskin/Noteskin").Noteskin,
      element: import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinElementOptions,
      options: import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinElementCreationData
    ) => import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinSprite
    init(): void
...
declare module "app/src/chart/gameTypes/noteskin/dance/cf-chrome/ModelRenderer" {
  ...
  import { NotedataEntry } from "app/src/chart/sm/NoteTypes"
  export class ModelRenderer {
    static arrowBodyTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static arrowFrameChromeTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static arrowFrameBlackTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static minePartsTex: BaseTexture<
      ...
      import("pixi.js").IAutoDetectOptions
    >
    static liftFrameChromeTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static liftFrameBlackTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static arrowBodyGeom: Geometry
...
declare module "app/src/chart/gameTypes/noteskin/dance/ddr-note/ModelRenderer" {
  ...
  export class ModelRenderer {
    ...
    static liftPartsTex: BaseTexture<
      ...
      import("pixi.js").IAutoDetectOptions
    >
    static liftQuantsTex: BaseTexture<
      import("pixi.js").Resource,
      import("pixi.js").IAutoDetectOptions
    >
    static arrowBodyGeom: Geometry
  ...
  const _default_2: {
    elements: {
      Left: {
        ...
        "Hold Active Body": (
          opt: import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinElementCreationData
        ) => HoldBody
        "Hold Inactive Body": (
          opt: import("app/src/chart/gameTypes/noteskin/Noteskin").NoteskinElementCreationData
        ) => HoldBody
...
declare module "app/src/chart/gameTypes/noteskin/pump/default/NoteRenderer" {
  ...
  export class NoteRenderer {
    ...
    static setNoteTex(
      ...
      columnName: string
    ): Texture<import("pixi.js").CanvasResource> | undefined
