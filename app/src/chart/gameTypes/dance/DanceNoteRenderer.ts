...
import holdBodyUrl from "../../../../assets/noteskin/dance/hold/body.png"
import holdCapUrl from "../../../../assets/noteskin/dance/hold/cap.png"
import fakeIconUrl from "../../../../assets/noteskin/dance/icon/fake.png"
import rollBodyUrl from "../../../../assets/noteskin/dance/roll/body.png"
import rollCapUrl from "../../../../assets/noteskin/dance/roll/cap.png"
...
export class DanceNoteRenderer {
  ...
  static setData(
    ...
    if (type == "Hold" || type == "Roll") {
      ...
      arrow.hold.holdBody.texture = type == "Hold" ? holdBodyTex : rollBodyTex
      arrow.hold.holdCap.texture = type == "Hold" ? holdCapTex : rollCapTex
